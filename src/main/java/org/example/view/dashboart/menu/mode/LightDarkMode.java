package org.example.view.dashboart.menu.mode;
...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("icon/svg/dark.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("icon/svg/light.svg"));
